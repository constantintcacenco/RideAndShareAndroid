        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Log.d(TAG, "onAuthStateChanged: user.getuid() "+ user.getUid());
                    ...
                    userRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if(task.isSuccessful()){
                                ...
                                if (document.exists()) {
                                    Log.d(TAG, "onAuthStateChanged: DocumentSnapshot data: " + document.getData());
                                } else {
                                    Log.d(TAG, "onAuthStateChanged: No such document. Creating:");

                                }
                                Log.d(TAG, "onComplete: successfully set the user client. ");// + ds.getData());
                                User user = task.getResult().toObject(User.class);
                                ((UserClient)(getApplicationContext())).setUser(user);
                                Log.d(TAG, "onComplete: user: "+user.getUsername());// + ds.getData());
