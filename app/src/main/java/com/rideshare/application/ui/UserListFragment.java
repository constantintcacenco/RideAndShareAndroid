...
import com.rideshare.application.adapters.UserRecyclerAdapter;
import com.rideshare.application.models.ClusterMarker;
import com.rideshare.application.models.PolylineData;
import com.rideshare.application.models.User;
import com.rideshare.application.models.UserLocation;
import com.rideshare.application.util.MyClusterManagerRenderer;
import com.rideshare.application.util.ViewWeightAnimationWrapper;
...
import static com.rideshare.application.Constants.MAPVIEW_BUNDLE_KEY;
            ...
            for(UserLocation userLocation: mUserLocations){
                ...
                try{
                    ...
                    if(userLocation.getUser().getUser_id().equals(FirebaseAuth.getInstance().getUid())){
                        ...
                        snippet = userLocation.getUser().getRole()+", go to " + userLocation.getUser().getUsername() + "?";
                    }

                    int avatar = 0;// R.drawable.cartman_cop; // set the default avatar
                    if(userLocation.getUser().getRole() == "traveller")
                        avatar = R.drawable.traveller;
                    else
                        avatar = R.drawable.driver2;
...
//        double bottomBoundary = 47.03 - .1;
//        double leftBoundary = 27.83 - .1;
//        double topBoundary = 47.03 + .1;
//        double rightBoundary = 27.83 + .1;
    ...
    private void setUserPosition() {
        for (UserLocation userLocation : mUserLocations) {
            //Log.d(TAG, "setUserPosition: userid: "+ userLocation.getUser().getUser_id() + " firebaseAuth: " + FirebaseAuth.getInstance().getUid());
            if (userLocation.getUser().getUser_id().equals(FirebaseAuth.getInstance().getUid())) {
...
//        setCameraView();
    ...
    private void calculateDirections(Marker marker){
        ...
        directions.origin(
                new com.google.maps.model.LatLng(//47.156984, 27.604276
