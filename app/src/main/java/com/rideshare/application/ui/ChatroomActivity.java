...
import com.rideshare.application.adapters.ChatMessageRecyclerAdapter;
import com.rideshare.application.models.ChatMessage;
        ...
        View.OnClickListener
{
    ...
    private void joinChatroom(){
        ...
        User user = ((UserClient)(getApplicationContext())).getUser();
        // user = new User("test@test.com", "OLPss4FzO7PgWMX0L73IKo66PP23", "test", null);
